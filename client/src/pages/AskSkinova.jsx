...
const AskSkinova = () => {
    ...
    // Scroll to the very top of the page when the component mounts
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-4 md:py-6 h-[calc(100vh-80px)] flex flex-col">
            <div className="shrink-0 bg-skinova-white border text-center border-skinova-olive/20 rounded-2xl p-4 mb-4 shadow-sm flex items-center justify-center gap-4 flex-wrap">
                <div className="flex items-center gap-3">
                    <div className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-skinova-bg text-skinova-coral border border-skinova-olive/20">
                        <Sparkles className="w-5 h-5" />
                    </div>
                    <div className="text-left">
                        <h1 className="text-lg font-bold text-skinova-dark tracking-tight leading-none">Ask SKINOVA</h1>
                        <p className="text-skinova-olive text-xs mt-1">Your secure AI guide</p>
                    </div>
                </div>
                <div className="flex flex-wrap justify-center gap-2 text-[10px] font-semibold">
                    <span className="bg-skinova-bg text-skinova-dark px-2.5 py-1 rounded-full border border-skinova-olive/10 flex items-center gap-1.5"><ShieldCheck className="w-3 h-3 text-skinova-coral" /> No Medical Diagnosis</span>
                    <span className="bg-skinova-bg text-skinova-dark px-2.5 py-1 rounded-full border border-skinova-olive/10 flex items-center gap-1.5"><ShieldCheck className="w-3 h-3 text-skinova-coral" /> Educational Only</span>
                </div>
            </div>

            <div className="bg-skinova-white rounded-2xl shadow-xl border border-skinova-olive/20 overflow-hidden flex flex-col flex-1 mb-4 min-h-[300px]">
                {/* Chat area */}
                <div ref={chatContainerRef} className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6 bg-skinova-bg">
            ...
            <div className="text-center shrink-0">
                <Link to="/analysis/new" className="inline-block bg-skinova-olive text-white px-5 py-2.5 rounded-lg font-bold shadow-md hover:bg-skinova-dark transition-colors uppercase tracking-wide text-[10px]">
